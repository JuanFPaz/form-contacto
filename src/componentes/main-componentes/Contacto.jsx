        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12 col-md-6'>
              <div className='contacto-saludo mt-3'>
                <p>
                  <b>¡Gracias por haber visitado mi Portfolio!</b> Espero que
                  haya sido de tu agrado y que hayas encontrado interesante el
              ...
              <div className='contacto-formulario'>
                ...
                <div>
                  {renderLoading && (
                    <Spinner className='mt-3' animation='grow' variant='success' />
                  )}
                  {renderData && (
                    <Alert className='mt-3' variant='success'> {data.message} </Alert>
                  )}
                  {renderError && (
                    <Alert className='mt-3' variant='danger'> {error.message} </Alert>
                  )}
                </div>
              </div>
            </div>
            <div className='col-12 col-md-6'>
              <div className='contacto-alternativo mt-3'>
                <p>
                  Si deseas <b>contactarte conmigo</b>, a continuación
                  encontrarás unos <b>enlaces</b> para que puedas enviarme un
                  mensaje a mi <b>perfil de linkedin</b>, mi{' '}
                  <b>perfil de github</b> o mi <b>correo electrónico.</b>
                </p>
              </div>
